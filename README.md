...
**Attension  
This Library is still under development and not stable and cannot be used in other project.
It is a fork fomr the famous ESP8266-IoT-Library from maakbas 
[maakbaas/esp8266-iot-framework](https://github.com/maakbaas/esp8266-iot-framework)
All rights from maakbaas are reserved !
