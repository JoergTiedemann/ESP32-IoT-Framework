...
export function DashboardPage(props) {
    ...
    const dashboardArrData2 = props.requestArrData2();
    
    const confItems = <DashboardItems API={props.API} items={Dash} data={dashboardData} Arrdata={dashboardArrData} Arrdata2={dashboardArrData2} />;
...
DashboardPage.propTypes = {    
    ...
    requestArrData2: PropTypes.func,
